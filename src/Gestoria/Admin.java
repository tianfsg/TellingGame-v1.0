...
public abstract class Admin {
	...
	protected ArrayList<Object> log;
            ...
            if(jugador.hasObj()) {//Tiene objeto equipado
                if(!jugador.getRoom().Objetos().isEmpty()) {//Hay mas Objetos en la Habitacion.
            		...
            		if(jugador.getRoom().Personajes().size() > 1) {//Hay mas Personajes en la Habitacion.
            			...
            			System.out.println("1. Moverse  2. Soltar/Tomar Objeto 3. Preguntar 4. Dar 5. Nada");
            			return 1;
               		...
               		if(jugador.getRoom().Personajes().size() > 1) {//Hay mas Personajes en la Habitacion.
            			System.out.println(jugador.getName() + " que accion deseas realizar?");
            			System.out.println("1. Moverse  2. Soltar Objeto 3. Preguntar 4. Dar 5. Nada");
            			return 3;
            	...
            	if(!jugador.getRoom().Objetos().isEmpty()) {//Hay Objetos en la Habitacion.
            		...
            		if(jugador.getRoom().Personajes().size() > 1) {//Hay Personajes en la Habitacion.
            			...
            			if(demand) {
            				System.out.println(jugador.getName() + " que accion deseas realizar?");
                            System.out.println("1. Moverse  2. Tomar Objeto 3. Preguntar 4. Pedir Objeto 5. Nada");
                            return 5;
                		}else {
                			System.out.println(jugador.getName() + " que accion deseas realizar?");
                            System.out.println("1. Moverse  2. Tomar Objeto 3. Preguntar 4. Nada");
                            return 6;
                		}
            		...
            		if(jugador.getRoom().Personajes().size() > 1) {//Hay Personajes en la Habitacion.
            			...
            			if(demand) {
            				System.out.println(jugador.getName() + " que accion deseas realizar?");
                            System.out.println("1. Moverse 2. Preguntar 3. Pedir Objeto 4. Nada");
                            return 8;
                		}else {
                			System.out.println(jugador.getName() + " que accion deseas realizar?");
                            System.out.println("1. Moverse 2. Preguntar 3. Nada");
                            return 9;
                		}
    ...
    public void takeOption(Personaje jugador) {
        ...
        if(!jugador.getIA()){//Es el jugador fisico.         
            ...
            case 10:
            	...
            	doOption(jugador, decision, rama);
            	break;default:System.err.println("Esa decision no es valida, intente de nuevo. linea 111 Admin.java\n");
                break;
            }
        }
    }
